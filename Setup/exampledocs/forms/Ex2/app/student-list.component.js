    ...
    return {
        ...
        execute: function() {
            StudentListComponent = (function () {
                ...
                StudentListComponent.prototype.add = function (studentId) {
                    this.router.navigate(['/add']);
                };
                StudentListComponent.prototype.edit = function (studentId) {
                    this.router.navigate(['/edit', studentId]);
                };
                StudentListComponent.prototype.delete = function (studentId) {
