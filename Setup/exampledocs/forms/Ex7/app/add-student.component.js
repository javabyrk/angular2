System.register(['@angular/core', '@angular/forms', '@angular/router', './student.service', './student'], function(exports_1, context_1) {
    ...
    var core_1, forms_1, forms_2, router_1, student_service_1, student_1;
    ...
    return {
        ...
        execute: function() {
            AddStudentComponent = (function () {
                function AddStudentComponent(studentService, router, builder) {
                ...
                AddStudentComponent.prototype.ngOnInit = function () {
                    this.studentForm = this.builder.group({
                        id: [this.student.id],
                        name: [this.student.name, [forms_2.Validators.required, forms_2.Validators.minLength(4)]] });
                };
                ...
                __decorate([
                    core_1.Input(), 
                    __metadata('design:type', forms_2.FormGroup)
                ...
                AddStudentComponent = __decorate([
                    ...
                    __metadata('design:paramtypes', [student_service_1.StudentService, router_1.Router, forms_1.FormBuilder])
                ], AddStudentComponent);
