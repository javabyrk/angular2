System.register(['@angular/core', "@angular/platform-browser", './app.component', "./student-list.component", "./add-student.component", "./edit-student.component", "./delete-student.component", './student.service', './app.routes'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, app_component_1, student_list_component_1, add_student_component_1, edit_student_component_1, delete_student_component_1, student_service_1, app_routes_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
