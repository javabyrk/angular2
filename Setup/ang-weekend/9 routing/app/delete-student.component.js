System.register(['@angular/core', '@angular/router', './student.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            DeleteStudentComponent = (function () {
                function DeleteStudentComponent(studentService, route, router) {
                ...
                DeleteStudentComponent.prototype.delete = function () {
            ...
            exports_1("DeleteStudentComponent", DeleteStudentComponent);
        }
    }
});
